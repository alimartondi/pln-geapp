  ...
  return (
    <section className="py-12">
      <ScrollWrapper name="register" className="container-wrapper">
        <div className="relative aspect-3/5 rounded-md md:aspect-16/11 lg:aspect-16/7 bg-[url('/images/register-image-background.png')] bg-cover bg-center after:absolute after:inset-0 after:bg-secondary/75 overflow-hidden">
