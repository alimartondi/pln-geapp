...
export default function ClusterItem({ index, cluster, onClick }: Props) {
  return (
    <button
      className="w-full flex items-center gap-4 border-b py-5 group hover:px-8 transition-all duration-300 hover:bg-primary hover:text-primary-foreground cursor-pointer hover:rounded-lg"
      onClick={onClick}
    >
      ...
      <div className="flex-1 space-y-1 text-left">
        ...
        <span className="block text-sm text-gray-500">({cluster.alias})</span>
      </div>
