...
export default function ClusterItemRegular({ index, cluster }: Props) {
  return (
    <div className="w-full flex items-center gap-4 border-b py-5 group hover:px-8 transition-all duration-300 hover:bg-primary hover:text-primary-foreground cursor-pointer hover:rounded-lg group">
